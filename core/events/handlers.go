...
func NewHandler(filterFun func(message eventtypes.Message) bool, fun func(eventtypes.Message) string) *Handler {
	return &Handler{
...
func DummyFilter(e eventtypes.Message) bool {
	return true
}
...
type Handler struct {
	filterFunc func(eventtypes.Message) bool
